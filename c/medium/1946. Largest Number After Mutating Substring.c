...
* replace each digit num[i] with the digit it maps to in change (i.e. replace num[i] with change[num[i]]).
...
/*
* 执行结果：通过
* 执行用时：20 ms, 在所有 C 提交中击败了88.24%的用户
* 内存消耗：11.7 MB, 在所有 C 提交中击败了78.43%的用户
*/