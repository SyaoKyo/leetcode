 ...
 * true(meaning you should only include restaurants with veganFriendly_i set to true) or
 ...
 * but in this case the filter veganFriendly = 0, therefore all restaurants are considered
 *
 * Example 3:
 * Input: restaurants = [[1,4,1,40,10],[2,8,0,50,5],[3,8,1,30,4],[4,10,0,10,3],[5,1,1,15,1]],
