...
* When the student number i is given a problem to solve, they will use chalk[i] pieces of chalk to solve that problem. However, 
* if the current number of chalk pieces is strictly less than chalk[i], then the student number i will be asked to replace the chalk.
...
/*
* 执行结果：通过
* 执行用时：112 ms, 在所有 C 提交中击败了97.13%的用户
* 内存消耗：12.9 MB, 在所有 C 提交中击败了90.02%的用户
* 通过测试用例：72 / 72
*/